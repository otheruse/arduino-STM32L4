...
### OtherUse
 * [OtherUse1-STM32L433RC](http://www.otheruse.nl)
...
### Board Manager
 ...
 4. Add ```https://otheruse.github.io/arduino-STM32L4/package_STM32L4_boards_index.json``` as an "Additional Board Manager URL"
...
##### Linux
 ...
 1. Go to ~/.arduino15/packages/otheruse/hardware/stm32l4/```<VERSION>```/drivers/linux/
...
###### USB Serial driver setup (Window XP / Windows 7 only)
 ...
 1. Go to ~/AppData/Local/Arduino15/packages/otheruse/hardware/stm32l4/```<VERSION>```/drivers/windows
...
### From git (for core development)
 ...
 4. Clone this repo: ```git clone https://github.com/otheruse/arduino-STM32L4.git otheruse/stm32l4```
